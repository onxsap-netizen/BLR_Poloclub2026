export const COC_VERSION = "2026-08-12"; // bump when you edit the text

export type CocSection = { title: string; items: string[] };

export const CODE_OF_CONDUCT: CocSection[] = [
  {
    title: "Respect First",
    items: [
...
export const CLUB_WHATSAPP = "917795980263"; // country code, no +
